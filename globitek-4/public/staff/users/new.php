...
if(is_post_request() && request_is_same_domain()) {
  ...
  if(isset($_POST['confirmPassword'])) { $user['confirmPassword'] = $_POST['confirmPassword']; }
...
<div id="main-content">
  ...
  <form action="new.php" method="post">
    ...
    lowercase letter, number, and symbol.<br />
    Password: <br />
    <input type="password" name="password" value="<?php echo h($user['password']); ?>" /><br />
    Confirm Password:<br />
    <input type="password" name="confirmPassword" value="<?php echo h($user['confirmPassword']); ?>" /><br />
